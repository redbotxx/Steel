...
Steel is a CSS based admin-side theme for "Textpattern CMS":http://textpattern.com.
...
# Type the following @git clone git@github.com:redbot/Steel.git@ to clone the theme.
...
# Either clone the Github repo to a local directory or use the "Download link":https://github.com/redbot/Steel/tarball/master on Github to get the source files onto your local machine.
