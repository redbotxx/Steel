...
# Either clone the Github repo to a local directory or use the Download link on Github to get the source files onot your local machine.
...
h2. Installation Using The @smd_admin_themes@ Plugin
